...
# ===========================================================================
HOST = "Nischayanay"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Founding Vyra"),
    ("kv", "Prev", "Built PromptBrain"),
    ("kv", "Focus", "AI products + systems"),
    ("kv", "Based", "India, working globally"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Build", "Full-stack + product design"),
    ("kv", "AI", "Prompts, APIs, data pipelines"),
    ("kv", "Ship", "Automation + digital products"),
    ("kv", "Create", "Motion + content systems"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Memory infrastructure for power users"),
    ("bul", "Making complex ideas easier to use"),
]
